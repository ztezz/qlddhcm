...
import { Settings, Save, Download, RefreshCw, AlertTriangle, Image as ImageIcon, Trash2, CheckCircle2, X, Info, Table, CheckSquare, Square, Check, Mail, Globe, DatabaseBackup, Cpu, HardDrive, Clock, FileText, Eye, EyeOff, Upload, History, Wifi, WifiOff, Zap } from 'lucide-react';
...
import { BACKUP_HISTORY_KEY, MAIL_PROVIDER_PRESETS, SETTING_METADATA, SETTINGS_GROUPS, TAB_KEYS, TAB_TITLES, validate, type BackupFormat, type BackupRecord, type BackupScope } from './systemSettingsConfig';
                ...
                {subTab === 'MAIL' && (
                    <div className="space-y-6 animate-in fade-in duration-300">
                        <div className="p-4 bg-rose-900/10 border border-rose-800/30 rounded flex gap-3 items-center mb-4">
                            ...
                            <p className="text-xs text-rose-300 italic">Chọn nhanh nhà cung cấp như GMail, Globe, DatabaseBackup, Outlook, Yahoo, Zoho, Brevo, SendGrid hoặc Mailgun. Hệ thống sẽ tự điền host và port phổ biến.</p>
                        </div>
